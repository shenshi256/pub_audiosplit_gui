...
################################################################################
## Form generated from reading UI file 'helpmodelwindow.ui'
##
...
class Ui_HelpModelWindow(object):
    def setupUi(self, HelpModelWindow):
        if not HelpModelWindow.objectName():
            HelpModelWindow.setObjectName(u"HelpModelWindow")
        HelpModelWindow.resize(600, 400)
        HelpModelWindow.setMinimumSize(QSize(600, 400))
        HelpModelWindow.setMaximumSize(QSize(800, 600))
        icon = QIcon()
        icon.addFile(u":/img/img/favicon.ico", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        HelpModelWindow.setWindowIcon(icon)
        self.centralwidget = QWidget(HelpModelWindow)
        ...
        HelpModelWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(HelpModelWindow)

        QMetaObject.connectSlotsByName(HelpModelWindow)
    # setupUi

    def retranslateUi(self, HelpModelWindow):
        HelpModelWindow.setWindowTitle(QCoreApplication.translate("HelpModelWindow", u"MainWindow", None))
        HelpModelWindow.setStyleSheet(QCoreApplication.translate("HelpModelWindow", u"QWidget#HelpModelWindow {\n"
...
"}", None))
        self.lblProjectHelp.setText(QCoreApplication.translate("HelpModelWindow", u"\u9879\u76ee\u4f7f\u7528\u5e2e\u52a9", None))
        self.btnClose.setText(QCoreApplication.translate("HelpModelWindow", u"\u5173\u95ed", None))
    # retranslateUi
